...
import 'package:whoop_triggerz/widgets/tools/record_container.dart';
...
class EasyPlayView extends StatefulWidget {
  static getRoute() {
    return PageRouteBuilder(
      ...
      pageBuilder: (_, __, ___) {
        return const EasyPlayView();
      },
    );
  }

  const EasyPlayView({Key? key}) : super(key: key);

  @override
  State<EasyPlayView> createState() => _EasyPlayViewState();
}

class _EasyPlayViewState extends State<EasyPlayView> {
  @override
